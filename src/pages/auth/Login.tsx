        ...
        <div className="relative z-10 text-center text-white space-y-8 max-w-sm">
          ...
          <div className="space-y-3">
            <h2 className="text-4xl font-black leading-tight">
              ...
              <span className="text-white/80">của bạn,</span><br />
              mọi lúc mọi nơi.
            </h2>
            <p className="text-white/70 text-base leading-relaxed">
              Đặt lịch khám, theo dõi sức khoẻ và kết nối với bác sĩ chuyên nghiệp — tất cả trong một ứng dụng.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3 text-sm">
            {[
              ...
              <div key={item} className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-xl px-4 py-2.5">
                <span>{item}</span>
              </div>
            ))}
          </div>
          ...
          {view === 'login' && (
            <div className="space-y-7 animate-in fade-in duration-300">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs text-muted-foreground font-medium">hoặc đăng nhập bằng SĐT</span>
                <div className="flex-1 h-px bg-border" />
              </div>
          ...
          {view === 'forgotPassword' && (
            <div className="space-y-7 animate-in fade-in duration-300">
              ...
              <div>
                ...
                <p className="mt-1.5 text-muted-foreground text-sm">
                  Nhập số điện thoại đã đăng ký, chúng tôi sẽ gửi hướng dẫn đặt lại mật khẩu cho bạn.
                </p>
              </div>

              <form onSubmit={handleForgotPassword} noValidate className="space-y-5">
                <div className="space-y-1.5">
                  <label htmlFor="forgot-phone" className="block text-sm font-semibold text-foreground">
                    Số điện thoại
                  </label>
                  <div className="relative">
                    <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-muted-foreground">
